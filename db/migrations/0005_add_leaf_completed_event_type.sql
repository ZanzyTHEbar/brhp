CREATE TABLE planner_events_v3 (
  id TEXT PRIMARY KEY,
...
INSERT INTO planner_events_v3 (id, session_id, scope_id, node_id, type, payload_json, occurred_at)
SELECT id, session_id, scope_id, node_id, type, payload_json, occurred_at
FROM planner_events;

DROP TABLE planner_events;

ALTER TABLE planner_events_v3 RENAME TO planner_events;
